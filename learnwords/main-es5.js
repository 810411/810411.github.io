...
var GoPageComponent = /** @class */ (function () {
    function GoPageComponent(storage) {
        this.storage = storage;
    }
    GoPageComponent.prototype.ngOnInit = function () {
        this.setInitState();
    };
    GoPageComponent.prototype.onNextClick = function () {
        this.turn++;
    ...
    GoPageComponent.prototype.setInitState = function () {
        this.turn = 0;
        this.result = 0;
    ...
    GoPageComponent.prototype.getRandomWord = function () {
        var index = Math.floor(Math.random() * this.wordList.length);
        return this.wordList[index];
    };
    GoPageComponent.ctorParameters = function () { return [
...
var RecentlyAddedPageComponent = /** @class */ (function () {
    function RecentlyAddedPageComponent(translateService, wordQueueService, storageService) {
    ...
    RecentlyAddedPageComponent.prototype.ngOnInit = function () {
        this.dict = this.storageService.getDictFromStorage();
        console.log(this.dict);
    };
    RecentlyAddedPageComponent.prototype.ngOnChanges = function (changes) {
        console.log(changes);
    };
    RecentlyAddedPageComponent.prototype.onTranslate = function () {
        var _this = this;
        this.canSave = false;
        this.wordQueueService.getDictItemsFromInput(this.userInput)
            .subscribe(function (data) { return _this.dictItems.push(data); }, function (err) { return console.error(); }, function () { return _this.canSave = true; });
    };
    RecentlyAddedPageComponent.prototype.onSave = function () {
    ...
    RecentlyAddedPageComponent.ctorParameters = function () { return [
    ...
    return RecentlyAddedPageComponent;
}());
...
var StorageService = /** @class */ (function () {
    ...
    StorageService.prototype.getDictFromStorage = function () {
        var arr = JSON.parse(this.localStorage.getItem(this.lang.value));
        return arr instanceof Array ? arr : [];
    };
    StorageService.prototype.addDictItems = function (dictItems) {
        var _this = this;
        var dict = this.getDictFromStorage();
        Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["from"])(dictItems)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(function (item) { return !dict.find(function (_a) {
            var word = _a.word;
            return word === item.word;
        }); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (item) { return dict.unshift(item); })).subscribe({
            complete: function () {
                _this.localStorage.setItem(_this.lang.value, JSON.stringify(dict));
            }
        });
    };
    StorageService.prototype.clearDictStorage = function () {
        this.localStorage.removeItem(this.lang.value);
    };
    StorageService.prototype.setLang = function (lang) {
        this.lang = lang;
    };
    StorageService.prototype.getLang = function () {
        return this.lang;
    };
    StorageService.prototype.setLevel = function (level) {
        this.level = level;
    };
    StorageService.prototype.getLevel = function () {
        return this.level;
    };
...
var TranslateService = /** @class */ (function () {
    function TranslateService(http, storageService) {
        this.http = http;
        this.storageService = storageService;
    ...
    TranslateService.prototype.getDictItem = function (word) {
        var _this = this;
        var lang = this.storageService.getLang().value;
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(word)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (item) { return _this.http.post("https://translate.yandex.net/api/v1.5/tr.json/translate?key=" + _this.key + "&lang=" + lang, "text=" + item, _this.httpOptions); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(3), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (item) { return ({
            word: word,
...
var WordQueueService = /** @class */ (function () {
    function WordQueueService(translateService) {
        this.translateService = translateService;
    }
    WordQueueService.prototype.getDictItemsFromInput = function (input) {
        var _this = this;
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["from"])(input.split('.'))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (item) { return item.trim(); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(function (item) { return item.length > 0; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["concatMap"])(function (item) { return _this.translateService.getDictItem(item); }));
    };
    WordQueueService.ctorParameters = function () { return [
...
var SettingsPageComponent = /** @class */ (function () {
    function SettingsPageComponent(storage, router) {
        this.storage = storage;
        this.router = router;
        this.languages = [
    ...
    SettingsPageComponent.prototype.setInitialState = function () {
        this.selectedLang = this.storage.getLang();
        this.selectedLevel = this.storage.getLevel();
    };
    SettingsPageComponent.prototype.onChangeLangSelect = function (eventValue) {
        this.selectedLang = this.languages.find(function (_a) {
            var value = _a.value;
            return value === eventValue;
        });
    };
    SettingsPageComponent.prototype.onAgreeClick = function () {
        this.storage.setLang(this.selectedLang);
        this.storage.setLevel(this.selectedLevel);
        this.router.navigate(['go']);
    };
    SettingsPageComponent.prototype.onResetClick = function () {
        this.storage.setLang({ display: 'Английский', value: 'ru-en' });
        this.storage.setLevel(5);
        this.setInitialState();
    };
    SettingsPageComponent.prototype.onClearClick = function () {
